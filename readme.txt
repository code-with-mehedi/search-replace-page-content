...
Search and replace content within pages effortlessly.
Works seamlessly in Gutenberg's code editor mode.
Supports replacing plain text, HTML, or other code snippets.
...
Once activated, open a page in the Gutenberg block editor. Switch to "Code Editor" mode, and you can search and replace any text or code content using this plugin's tools.

= Does this plugin work with all WordPress pages? =
Yes, it works with any page content editable in Gutenberg. However, it is specifically designed for use in the code editor mode.

= Is it compatible with the latest WordPress versions? =
Yes, the plugin is tested and fully compatible with the latest WordPress version, up to 6.7.
